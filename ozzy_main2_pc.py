#from comSerial import *  # Biblioteca que inclui funções de comunicação serial
import time 
import cv2
from utils import *  # Outras funções utilitárias
import numpy as np
    ...
    def ozzy_see(self):
        ...
        if self.results.detections:
            ...
            for detection in self.results.detections:
                mp_drawing.draw_detection(self.frame,detection)
