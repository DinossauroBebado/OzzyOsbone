    ...
    def ozzy_see(self):
        ...
        if self.results.detections:
            ...
            if len(self.faces) > 0:
                ...
                # Garantir que o índice esteja dentro dos limites da lista
                ...
                if self.target_face_index < len(self.faces):
                    ...
                    cv2.rectangle(self.frame, (target_face[0], target_face[1]), (target_face[0] + target_face[2], target_face[1] + target_face[3]), (0, 0, 255), 2)  # Bounding box vermelho
